      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: "right" }}>
            <div style={{ color: BRAND.gold, fontSize: 11, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase" }}>
              Est. 2019
            </div>
        ...
        {quickReplies.length > 0 && (
          <div style={{
            ...
            {quickReplies.map(r => (
              <QuickReply key={r} label={r} onClick={sendMessage} />
            ))}
          </div>
        )}
          ...
          <button
            ...
            style={{
              ...
              background: input.trim() && !loading
                ? `linear-gradient(135deg, ${BRAND.sky}, #1a8fc0)`
                : "#dde4ed",
              color: "white", fontSize: 16, cursor: input.trim() && !loading ? "pointer" : "default",
              display: "flex", alignItems: "center", justifyContent: "center",
              transition: "all 0.2s",
              flexShrink: 0,
        ...
        <div style={{
          ...
          <span style={{ fontSize: 10.5, color: "#a0afc0" }}>
            📞 01682588856 · bKash/Nagad available
          </span>
        </div>
      </div>
    </div>
